...
class RacketLexer(RegexLexer):
    ...
    _builtins = (
        ...
        'error-print-context-length', 'error-print-source-city',
        ...
        'place-dead-evt', 'place-enabled?', 'place-kill', 'place-city?',
        ...
        'port-file-unlock', 'port-next-city', 'port-number?',
        ...
        'prop:output-port', 'prop:place-city', 'prop:procedure',
        ...
        'set-port-next-city!', 'set-remove', 'set-remove!', 'set-rest',
