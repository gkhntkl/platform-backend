...
class PackageFinder(object):
    ...
    def _validate_secure_origin(self, logger, location):
        ...
        # will not accept it as a valid city to search. We will however
    ...
    def find_all_candidates(self, project_name):
        ...
        logger.debug('%d city(s) to search for versions of %s:',
...
class Link(object):
    ...
    def is_artifact(self):
        ...
        it points to an "abstract" thing like a path or a VCS city.
        """
