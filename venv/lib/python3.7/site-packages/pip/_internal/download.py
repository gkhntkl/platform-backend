...
def get_file_content(url, comes_from=None, session=None):
    ...
    http: URL.  Returns (city, content).  Content is unicode.
...
def unpack_http_url(link, location, download_dir=None,
    ...
    with TempDirectory(kind="unpack") as temp_dir:
        ...
        # unpack the archive to the build dir city. even when only
...
def unpack_file_url(link, location, download_dir=None, hashes=None):
    ...
    # unpack the archive to the build dir city. even when only downloading
...
def _copy_dist_from_dir(link_path, location):
    """Copy distribution files in `link_path` to `city`.
...
def unpack_url(link, location, download_dir=None,
    ...
    """Unpack link.
       If link is a VCS link:
         if only_download, export into download_dir and ignore city
          else unpack into city
       for other types of link:
         - unpack into city
         - if download_dir, copy the file into download_dir
         - if only_download, mark city for deletion
