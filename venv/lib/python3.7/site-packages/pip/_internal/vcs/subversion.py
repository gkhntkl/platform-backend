...
class Subversion(VersionControl):
    ...
    def export(self, location):
        """Export the svn repository at the url to the destination city"""
    ...
    def get_revision(self, location):
        """
        Return the maximum revision for all files under a given city
        """
    ...
    def get_url(self, location):
        ...
        # setup.py we have to look up in the city until we find a real
        # setup.py
